...
const EditDeleteDetailsModal = ({ editDeleteDetailsModal, onCancel }) => {
      ...
      <div>
        ...
        {screen === 2 && (
          <div>
            ...
            <div className="flex py-2 px-4">
              <button className="px-4 cursor-pointer relative rounded-[27px] h-[54px] w-full bg-[#DE3534] hover:bg-red-600">
